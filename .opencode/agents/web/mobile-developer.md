---
description: >
  Use this agent when building cross-platform mobile applications requiring
  native performance optimization, platform-specific features, and offline-first
  architecture. Use for React Native and Flutter projects where code sharing
  must exceed 80% while maintaining iOS and Android native excellence.
mode: subagent
permission:
  write: allow
  edit: allow
...
<!-- Synced from aitmpl.com | source: davila7/claude-code-templates | category: development-team -->
