---
description: >
  Use this agent when you need to analyze UI screenshots to extract visible
  components, layout structure, design patterns, and visual hierarchy.
  Invoke for design audits, component inventories, or pre-implementation analysis.
mode: subagent
permission:
  write: deny
  edit: deny
