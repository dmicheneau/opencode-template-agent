#!/usr/bin/env python3
# ⚠️ AUTO-SYNCED from aitmpl.com — Review before executing
...
def update_task_status(
    ...
    for line in lines:
        ...
        if task_data and task_data["title"] == task_title:
            ...
            # Add failure reason right after the task line
        ...
        # Strip existing reason lines to avoid duplicates
        if in_target_task and re.match(r"^\s*- (?:reason|error):", line):
            continue
