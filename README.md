...
Registre curé de **49 agents IA** pour [OpenCode](https://opencode.ai), distribué via un CLI zero-dependency. Les agents sont des fichiers `.md` contenant des system prompts pour configurer des assistants IA spécialisés.

Source : [aitmpl.com](https://www.aitmpl.com/agents) (413+ agents disponibles) + 5 agents custom.
...
49 agents — 4 primary (`Tab` dans OpenCode) + 45 subagents (`@catégorie/nom`).
...
8 packs prédéfinis pour installer des groupes d'agents cohérents.
...
├── manifest.json            # 49 agents, 11 catégories, 8 packs
